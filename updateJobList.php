                    ...
                    <div class="editDetials">
                        <div class="pagehead">
                            ...
                            <form action="#" onsubmit="return editJobValidation()">
                                <input type="text" required class="jobContent" required id="title" onfocus="highlight('title')" onblur="removeH('title')" placeholder="Job Listing Title">
                                <br>
                                ...
                                <span>
                                    <input type="text" required class="jobContent" id="exper" onfocus="highlight('exper')" onblur="removeH('exper')" placeholder="0-x years experience">
                                </span>
                                <br>
                                <i class="fas fa-money-bill-wave icon"></i>
                                <span>
                                    <input type="text" class="jobContent" id="salary" onfocus="highlight('salary')" onblur="removeH('salary')" placeholder="$$$ - $$$ anual salary">
                                </span>
                                <br>
                                <i class="fas fa-play icon"></i>
                                <span>
                                    <input type="text" class="jobContent" id="date" onfocus="highlight('date')" onblur="removeH('date')" placeholder="start date">
                                </span>
                                <br>
                                <p>
                                    <input type="text" class="jobContent" required id="skills" onfocus="highlight('skills')" onblur="removeH('skills')" placeholder="Required Skills">
                                </p>
                                <br>
                                <textarea type="text" class="jobContent descript" required id="descript" onfocus="highlight('descript')" onblur="removeH('descript')" placeholder="Description"> </textarea>
